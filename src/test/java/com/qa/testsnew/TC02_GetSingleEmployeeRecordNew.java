...
public class TC02_GetSingleEmployeeRecordNew extends TestBaseRevised
{
	@Test
	public void getSingleEmployeeRecordAPITestWithHeaders() throws ClientProtocolException, IOException, InterruptedException
	{
	       restClientNew = new RestAPIClientNew();
	       HashMap<String, String> headerMap = new HashMap<String, String>();
	       headerMap.put("Content-Type", "application/json");
	     	       
	       closeableHttpResponse = restClientNew.get(urlSingleEmployeeRecord, headerMap); 
	       Thread.sleep(3000);
		   ...
		   String employeeNameValue = TestUtilitiesRevised.getValueByJPath(responseJson, "/data/employee_name");
		   System.out.println("employee name Value is: " + employeeNameValue);	
		   softassert.assertEquals(employeeNameValue, "Garrett Winters", "Employee name at index 0 is not Garrett Winters");
	}
}
